<template>
  <div class="flex-container">
    <div class="text-center">
      ...
      <h3 class="fadeIn">Página não encontrada :(</h3>
      <v-btn
        depressed
        to="/"
      >
...
@keyframes colorSlide {
  0% { background-color: #F8433F; }
  25% { background-color: #ee7977; }
  50% { background-color: #faa4a2; }
  75% { background-color: #f5cbca; }
  100% { background-color: #ad8888; }
}
